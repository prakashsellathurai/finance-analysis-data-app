...
def main():
    ...
    st.sidebar.info('This app is a simple example of '
                    ...
                    '\nIt is maintained by [Prakash Sellathurai]('
                    'https://twitter.com/prakash1729brt).\n\n'
                    'Check the code at https://github.com/prakashsellathurai/finance-analysis-data-app')
